/*
-----------------------------------------------------------------------------------
-- Script: Drop and Recreate silver Layer Tables in DataWarehouse
-- Author: [Your Name]
-- Date: [Current Date]
--
-- Description:
-- This script ensures that the 'silver' schema contains fresh tables by:
-- 1. Checking if each table exists and dropping it if found.
-- 2. Recreating the tables from scratch.
--
-- Warnings:
-- - **This script will delete all existing data** in the 'silver' schema tables.
